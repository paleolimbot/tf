...
extern SEXP tf_c_session_xptr_new(SEXP graph_xptr);
extern SEXP tf_c_session_xptr_close(SEXP session_xptr);
...
extern SEXP tf_c_array_from_tensor_xptr(SEXP tensor_xptr, SEXP ptype);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"tf_c_session_xptr_new", (DL_FUNC) &tf_c_session_xptr_new, 1},
    {"tf_c_session_xptr_close", (DL_FUNC) &tf_c_session_xptr_close, 1},
    ...
    {"tf_c_array_from_tensor_xptr", (DL_FUNC) &tf_c_array_from_tensor_xptr, 2},
